...
public class BlogDAO {
    ...
    private String BLOG_LIST_BLOGGER = "select b.blog_id, b.cnt_display_post, b.status, b.title, b.tag, u.user_name from blog b, blog_user u where b.user_id=u.user_id and b.user_name like '%'||?||'%' order by b.title";
