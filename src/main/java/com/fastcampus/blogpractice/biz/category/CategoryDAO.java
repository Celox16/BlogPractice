...
public class CategoryDAO {
    ...
    // SQL 명령들
    private String CATEGORY_INSERT = "insert into category(blog_id, category_id, category_name, displayType, description, cnt_display_post) values (?, (select nvl(max(category_id), 0) + 1 from category), ?, ?, ?, ?)";
